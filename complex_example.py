#!/usr/bin/env python3
"""
A more complex example of using the webcrawler to scrape sites with GDPR banners
...
def scrape_with_custom_logic(url, headless=True, browser='auto', delay=2, screenshot=False):
    """
    ...
    if images:
        ...
        for i, img in enumerate(images[:3], 1):
            ...
            print(f"{i}. {alt_text}: {img['url'][:100]}...")
...
def main():
    parser = argparse.ArgumentParser(description='Complex Web Crawler Example')
